...
export interface HypercertsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
...
export interface Hypercerts extends BaseContract {
  connect(runner?: ContractRunner | null): Hypercerts;
  waitForDeployment(): Promise<this>;

  interface: HypercertsInterface;
